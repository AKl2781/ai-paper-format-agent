...
当前版本：`v1.0-showcase release candidate / 暑期实习展示版候选`

当前推荐演示基线：当前 HEAD `c73a4f8 feat: enhance agent trace visualization`。该基线包含 v0.9.5 trace UI 相关增强；`v0.9.4-demo-screenshot-package` 是上一阶段截图包 tag。完成本轮封版整理并通过最小回归后，建议再打 tag：`v1.0-showcase`。
...
- v1.0-showcase 封版候选：当前 HEAD 已包含 v0.9.5 trace UI 相关增强，推荐作为暑期实习展示版候选基线；封版 tag 尚未创建。
...
- 当前 HEAD：包含 v0.9.5 trace UI 相关增强，是本次 `v1.0-showcase release candidate` 的推荐演示基线。
- `v1.0-showcase`：本轮文档整理和最小回归 PASS 后建议创建的封版 tag，当前尚未打 tag。
